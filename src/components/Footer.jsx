    ...
    return (
        <a
            ...
            className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center
                 text-blue-300 hover:text-accent hover:border-accent/40 hover:bg-accent/10 transition-all duration-300"
            aria-label={type}
        >
            {icons[type] || null}
        </a>
...
export default function Footer() {
    ...
    return (
        <footer className="relative pt-20 pb-8" style={{ background: 'linear-gradient(to bottom, #0a1035 0%, #060b22 100%)' }}>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    ...
                    {/* Rutas */}
                    <div>
                        <h4 className="text-white font-bold mb-4 text-sm">Rutas</h4>
                        <ul className="space-y-2">
                        ...
                        <h4 className="text-white font-bold mb-3 mt-6 text-sm">Empresa</h4>
                        <ul className="space-y-2">

                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center gap-3">
                            ...
                            >
                                ...
                                <span className="font-semibold">5683-6688</span>
                            </a>
                            <a
                                href="https://wa.me/50256836688?text=Hola%21%20👋%20Quiero%20cotizar%20un%20envío%20📦"
                                target="_blank"
            ...
            >
                ...
                <div className="relative flex flex-col items-center justify-start pt-24 h-full gap-4 p-6 overflow-y-auto">
                    ...
                    <div className={`mt-8 flex flex-col gap-4 items-center transition-all duration-300 delay-100 ${mobileOpen ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
                        <a href="tel:56836688" className="flex items-center gap-2 text-accent font-semibold text-lg">
                            <Phone className="w-5 h-5" /> 5683-6688
                        </a>
                        <a
                            href="https://wa.me/50256836688?text=Hola%21%20👋%20Quiero%20cotizar%20un%20envío%20📦"
                            target="_blank"
                        ...
                        >
                            <WhatsAppIcon className="w-5 h-5 mr-1" /> Cotizar Envío
                        </a>
                    </div>
                </div>
            </div>

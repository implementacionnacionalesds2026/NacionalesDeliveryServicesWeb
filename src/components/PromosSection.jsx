        ...
        <section id="promociones" className="py-24 relative overflow-hidden bg-gradient-to-b from-[#060b22] to-[#0a1035]">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    {/* Backdrop */}
                    <div 
                        className="absolute inset-0 bg-[#0a1035]/90 backdrop-blur-sm"
                        onClick={() => setIsModalOpen(false)}
                    />
                    
                    {/* Modal Content */}
                    <div className="relative glass-light bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl animate-in zoom-in duration-300">
                        <button 
                            onClick={() => setIsModalOpen(false)}
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h3 className="text-2xl font-black text-slate-800 mb-2">Selecciona tu Ruta</h3>
                        ...
                        <div className="grid gap-3">
                            {routes.map((route) => (
                                <button
                                    ...
                                    className="w-full text-left p-4 rounded-xl border-2 border-slate-100 hover:border-lime-400 hover:bg-lime-50 transition-all group flex items-center justify-between"
                                >
                                    <span className="font-semibold text-slate-700 group-hover:text-lime-700">{route.name}</span>
                                    <span className="opacity-0 group-hover:opacity-100 transition-opacity text-lime-600 flex items-center gap-2 text-sm font-bold">
                                        Continuar
